	...
	<div class="account-right-div">
					...
					<div class="dashboard-inner language_section">
						<div class="main-dash-summry Edit-profile">
							<form name="frmEditGroup" id="frmEditGroup" action="<?php echo base_url(); ?>cdadmin/add_new_langauge" method="post">
											<div class="input-row full-input-width">
												<div class="full">
													<div class="input-block">
														<label class="required">Langauge Name :</label>
														<span class='reg_span'>
															<input type="text" name="langauge_name" id="langauge_name" class="inputbox-main specialChar" value=""   />
											...
											<div class="input-row full-input-width">
												<div class="full">
													<div class="input-block">
														...
														<span class='reg_span'>
															<input type="text" name="langaue_short_name" id="langaue_short_name" class="inputbox-main specialChar" value=""   />
														</span>
													</div>
												</div>
											</div>
			...
			$("#frmEditGroup").validate({
				rules: {
					langauge_name:{
								required:true,
								remote: {
									url: "<?php echo base_url().'cdadmin/check_language/'?>",
									type: "post",
									data: {
						...
						langaue_short_name:{
								...
								remote: {
									...
									type: "post",
									data: {
									langaue_short_name: function() {
										return $( "#langaue_short_name" ).val();
									  }
									}
								}
							},				
				...
				messages: {
					...
					langaue_short_name:{						
						required : "Please enter short name for language i.e.- en for english",
						remote:"Language short name already exist, try another."
					},	
